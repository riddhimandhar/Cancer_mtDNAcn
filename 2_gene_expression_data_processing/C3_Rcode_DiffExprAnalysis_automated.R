...
sink("../results_GeneExprAnalysis/DiffExprAnalysis_gene/Stats_Up_Down_reg.txt") 
...
for (canctype in canctypelist) { 
	#print(canctype) 
        ...
        datafile = paste('../geneExpression_data/gene/canctype_specific_data/',canctype,'_counts_data.txt',sep="") 
	sampfile = paste('../geneExpression_data/gene/canctype_specific_data/Metadata/Metadata_',canctype,'.txt',sep="") 
	...
	wrf = paste('../results_GeneExprAnalysis/DiffExprAnalysis_gene/Distanceplots/',canctype,'_distmatrix.pdf',sep="") 
...
## PCAtools 
	...
	wrf = paste('../results_GeneExprAnalysis/DiffExprAnalysis_gene/PCAplots/',canctype,'_PCA.pdf',sep="")
	...
	wrf = paste('../results_GeneExprAnalysis/DiffExprAnalysis_gene/PCAplots/',canctype,'_pairplots_PCA.pdf',sep="")
...
## ==== Differential expression ==== 
	...
	wrf = paste('../results_GeneExprAnalysis/DiffExprAnalysis_gene/MAplots/',canctype,'_MAplot.pdf',sep="")
	pdf(file = wrf, useDingbats=F) 
	...
	wfile = paste('../results_GeneExprAnalysis/DiffExprAnalysis_gene/DESeq_results/',canctype,'_High_vs_Low_mtDNA.txt',sep='')
	#write.table(res,'../results_GeneExprAnalysis/DiffExprAnalysis_gene/DESeq_results/Liver-HCC_High_vs_Low_mtDNA.txt',quote=F)
	...
	wfile1 = paste('../results_GeneExprAnalysis/DiffExprAnalysis_gene/DESeq_results/',canctype,'_Upreg_High_vs_Low_mtDNA.txt',sep='')
	write.table(upreg,wfile1,quote=F)
	rm(wfile1) 
	
	wfile2 = paste('../results_GeneExprAnalysis/DiffExprAnalysis_gene/DESeq_results/',canctype,'_Dnreg_High_vs_Low_mtDNA.txt',sep='')
...
## ===== Volcano plot ======== 
	...
	wrf = paste('../results_GeneExprAnalysis/DiffExprAnalysis_gene/Volcanoplots/',canctype,'_Volcanoplot.pdf',sep="")
...
## ====== Topgene Normalized count plot ========= 
	...
	wrf = paste('../results_GeneExprAnalysis/DiffExprAnalysis_gene/TopGeneExprplot/',canctype,'_TopgeneExpr.pdf',sep="")
...
## ========= Heatmap Top N gene expression ===========
	...
	wrf = paste('../results_GeneExprAnalysis/DiffExprAnalysis_gene/Top40heatmap/',canctype,'_Top40Heatmap.pdf',sep="")
